...
public class TrailerListAdapter extends RecyclerView.Adapter<TrailerListAdapter.TrailerViewHolder>{
    ...
    public TrailerListAdapter(Context context, ArrayList<TrailerModel> arrayList, HomeFragment clickListener) {
        this.arrayList = arrayList;
        this.context = context;
    //    this.clickListener = (RecyclerViewClickListener) clickListener;
    }
    ...
    public TrailerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        ...
        // trailerViewHolder.trailer_card;
